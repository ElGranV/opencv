...
while(True):
    ...
    #win-stride sert à déterminer la précision de l'évaluation (en compétition avec le temps de calcul)
    #plus la fenêtre est petite, plus la précision est grande
